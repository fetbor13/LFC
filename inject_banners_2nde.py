...
files_and_sims = {
    ...
    "2nde_chapitre8.html": "optics_lenses",
    "2nde_chapitre9.html": "ohms_law",
...
for filename, sim_id in files_and_sims.items():
    ...
    # Try multiple common tab IDs
    pattern = r'(id="tab-simulations"[^>]*>|id="tab-animations"[^>]*>|id="p-sim"[^>]*>|id="panel-simulations"[^>]*>)'
